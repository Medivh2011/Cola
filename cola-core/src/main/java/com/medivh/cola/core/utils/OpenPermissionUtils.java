...
public class OpenPermissionUtils {
    ...
    private static OpenPermissionUtils sOpenPermissionUtils;

    private OpenPermissionUtils(Context context) {
        this.mContext = context.getApplicationContext();
        packageName = context.getPackageName();
    }

    public static OpenPermissionUtils getInstance(Context context)
    {
        if ( null == sOpenPermissionUtils)
        {
            synchronized (OpenPermissionUtils.class)
            {
                if (null == sOpenPermissionUtils)
                {
                    sOpenPermissionUtils = new OpenPermissionUtils(context);
                }
            }
        }
        return sOpenPermissionUtils;
    }
