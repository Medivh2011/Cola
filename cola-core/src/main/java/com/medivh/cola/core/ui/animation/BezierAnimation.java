package com.medivh.cola.core.ui.animation;
...
import com.medivh.cola.core.utils.ScreenUtils;


public final class BezierAnimation {

    public static void addCart(ColaDelegate delegate, View start, View end,
